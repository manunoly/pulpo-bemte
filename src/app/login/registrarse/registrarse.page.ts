...
export class RegistrarsePage implements OnInit {
  ...
  async iniciar() {
    ...
    this.registroForm = this.fb.group({
      ...
      email: [data && data['email'] ? data['email'] : "", [Validators.required, Validators.email, Validators.maxLength(50)]],
      password: ["", [Validators.required, Validators.minLength(8), Validators.maxLength(50)]],
      password1: ["", [Validators.required, Validators.minLength(8), Validators.maxLength(50)]],
      nombre: [data && data['first_name'] ? data['first_name'] : "", [Validators.required, Validators.minLength(3), Validators.maxLength(50)]],
      apellido: [data && data['last_name'] ? data['last_name'] : "", [Validators.required, Validators.minLength(3), Validators.maxLength(50)]],
      apodo: [data && data['email'] ? data['email'].split('@')[0] : "", [Validators.required, Validators.minLength(8), Validators.maxLength(50)]],
      cedula: [""],
      token: [""],
      sistema: [""],
